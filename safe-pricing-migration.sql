-- Safe Pricing Migration to Weekly ($3) and Monthly ($9) with Unlimited Job Search
-- Run this in your Supabase SQL Editor

-- Step 1: First, update existing data to new plan types BEFORE changing constraints
...
-- Step 2: Now update the plan constraint (after data is migrated)
...
-- Step 3: Update the upgrade_source constraint
...
-- Step 4: Update the reset_daily_credits function for unlimited job search
...
-- Step 5: Update the get_available_cron_slots function
...
-- Step 6: Update the get_max_cron_jobs function
...
-- Step 7: Create function to get max daily fetches for plan
...
-- Step 8: Insert sample user profiles for testing with new plans
...
-- Step 9: Create indexes for new plan types
...
-- Step 10: Create a view for easy plan management
...
-- Step 11: Create function to upgrade user plan
...
-- Step 12: Create function to check if user can perform unlimited actions
...
-- Step 13: Create function to get user's current limits
