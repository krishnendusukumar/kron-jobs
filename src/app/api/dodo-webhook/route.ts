...
export async function POST(req: NextRequest) {
    try {
        ...
        // Log the full raw body and headers for debugging
        console.log('🟢 DODO WEBHOOK RAW BODY:', rawBody);
        console.log('🟢 DODO WEBHOOK HEADERS:', Object.fromEntries(headersList.entries()));
        ...
        // For debugging: return the full payload in the response
